...
#ifndef LIBSIMDPP_SIMDPP_CORE_I_SLRI_L_H
#define LIBSIMDPP_SIMDPP_CORE_I_SLRI_L_H
...
int8<N,expr_empty> slri(const int8<N,E>& a, unsigned count)
{
    uint8<N> qa = a.eval();
...
template<unsigned N, class E> SIMDPP_INL
uint8<N,expr_empty> slri(const uint8<N,E>& a, unsigned count)
{
...
*/
template<unsigned N, class E> SIMDPP_INL
int16<N,expr_empty> slri(const int16<N,E>& a, unsigned count)
{
    uint16<N> qa = a.eval();
    return detail::insn::i_shift_l(qa, count);
}
...
template<unsigned N, class E> SIMDPP_INL
uint16<N,expr_empty> slri(const uint16<N,E>& a, unsigned count)
{
    return detail::insn::i_shift_l(a.eval(), count);
}
...
*/
template<unsigned N, class E> SIMDPP_INL
int32<N,expr_empty> slri(const int32<N,E>& a, unsigned count)
{
    uint32<N> qa = a.eval();
    return detail::insn::i_shift_l(qa, count);
}
...
template<unsigned N, class E> SIMDPP_INL
uint32<N,expr_empty> slri(const uint32<N,E>& a, unsigned count)
{
    return detail::insn::i_shift_l(a.eval(), count);
}
...
*/
template<unsigned N, class E> SIMDPP_INL
int64<N,expr_empty> slri(const int64<N,E>& a, unsigned count)
{
    uint64<N> qa = a.eval();
    return detail::insn::i_shift_l(qa, count);
}
...
template<unsigned N, class E> SIMDPP_INL
uint64<N,expr_empty> slri(const uint64<N,E>& a, unsigned count)
{
    return detail::insn::i_shift_l(a.eval(), count);
}
...
*/
template<unsigned N, class E> SIMDPP_INL
int8<N,expr_empty> slri(const int8<N,E>& a, const uint8<N,E>& count)
{
...
template<unsigned N, class E> SIMDPP_INL
uint8<N,expr_empty> slri(const uint8<N,E>& a, const uint8<N,E>& count)
{
...
*/
template<unsigned N, class E> SIMDPP_INL
int16<N,expr_empty> slri(const int16<N,E>& a, const uint16<N,E>& count)
{
...
template<unsigned N, class E> SIMDPP_INL
uint16<N,expr_empty> slri(const uint16<N,E>& a, const uint16<N,E>& count)
{
...
*/
template<unsigned N, class E> SIMDPP_INL
int32<N,expr_empty> slri(const int32<N,E>& a, const uint32<N,E>& count)
{
...
template<unsigned N, class E> SIMDPP_INL
uint32<N,expr_empty> slri(const uint32<N,E>& a, const uint32<N,E>& count)
{
...
int8<N,expr_empty> slri(const int8<N,E>& a)
{
    static_assert(count < 8, "Shift out of bounds");
    uint8<N> qa = a.eval();
    return detail::insn::i_shift_r_wrapper<count == 0>::template run<count>(qa);
}

template<unsigned count, unsigned N, class E> SIMDPP_INL
uint8<N,expr_empty> slri(const uint8<N,E>& a)
{
    static_assert(count < 8, "Shift out of bounds");
...
*/
template<unsigned count, unsigned N, class E> SIMDPP_INL
int16<N,expr_empty> slri(const int16<N,E>& a)
{
...
template<unsigned count, unsigned N, class E> SIMDPP_INL
uint16<N,expr_empty> slri(const uint16<N,E>& a)
{
    static_assert(count < 16, "Shift out of bounds");
    return detail::insn::i_shift_r_wrapper<count == 0>::template run<count>(a.eval());
}
...
*/
template<unsigned count, unsigned N, class E> SIMDPP_INL
int32<N,expr_empty> slri(const int32<N,E>& a)
{
...
template<unsigned count, unsigned N, class E> SIMDPP_INL
uint32<N,expr_empty> slri(const uint32<N,E>& a)
{
    static_assert(count < 32, "Shift out of bounds");
    return detail::insn::i_shift_r_wrapper<count == 0>::template run<count>(a.eval());
}
...
*/
template<unsigned count, unsigned N, class E> SIMDPP_INL
int64<N,expr_empty> slri(const int64<N,E>& a)
{
...
template<unsigned count, unsigned N, class E> SIMDPP_INL
uint64<N,expr_empty> slri(const uint64<N,E>& a)
{
    static_assert(count < 64, "Shift out of bounds");
    return detail::insn::i_shift_r_wrapper<count == 0>::template run<count>(a.eval());
}

...
#ifndef LIBSIMDPP_SIMDPP_DETAIL_INSN_I_PREFIX_MAX_H
#define LIBSIMDPP_SIMDPP_DETAIL_INSN_I_PREFIX_MAX_H
...
static SIMDPP_INL
int8x16 prefix_max(const int8x16& a, const int8x16& b)
{
#if SIMDPP_USE_NULL
...
#if SIMDPP_USE_AVX2
static SIMDPP_INL
int8x32 prefix_max(const int8x32& a, const int8x32& b)
{
...
SIMDPP_INL int8<64> prefix_max(const int8<64>& a, const int8<64>& b)
{
...
int8<N> prefix_max(const int8<N>& a, const int8<N>& b)
{
...
static SIMDPP_INL
uint8x16 prefix_max(const uint8x16& a, const uint8x16& b)
{
#if SIMDPP_USE_NULL
    return detail::null::max(a, b);
#elif SIMDPP_USE_SSE2
...
#if SIMDPP_USE_AVX2
static SIMDPP_INL
uint8x32 prefix_max(const uint8x32& a, const uint8x32& b)
{
...
template<unsigned N> SIMDPP_INL
uint8<N> prefix_max(const uint8<N>& a, const uint8<N>& b)
{
...
static SIMDPP_INL
int16x8 prefix_max(const int16x8& a, const int16x8& b)
{
#if SIMDPP_USE_NULL
    return detail::null::max(a, b);
#elif SIMDPP_USE_SSE2
...
#if SIMDPP_USE_AVX2
static SIMDPP_INL
int16x16 prefix_max(const int16x16& a, const int16x16& b)
{
...
template<unsigned N> SIMDPP_INL
int16<N> prefix_max(const int16<N>& a, const int16<N>& b)
{
...
static SIMDPP_INL
uint16x8 prefix_max(const uint16x8& a, const uint16x8& b)
{
#if SIMDPP_USE_NULL
    return detail::null::max(a, b);
#elif SIMDPP_USE_SSE4_1
...
#if SIMDPP_USE_AVX2
static SIMDPP_INL
uint16x16 prefix_max(const uint16x16& a, const uint16x16& b)
{
...
template<unsigned N> SIMDPP_INL
uint16<N> prefix_max(const uint16<N>& a, const uint16<N>& b)
{
...
static SIMDPP_INL
int32x4 prefix_max(const int32x4& a, const int32x4& b)
{
#if SIMDPP_USE_NULL
    return detail::null::max(a, b);
#elif SIMDPP_USE_SSE4_1
...
#if SIMDPP_USE_AVX2
static SIMDPP_INL
int32x8 prefix_max(const int32x8& a, const int32x8& b)
{
...
static SIMDPP_INL
int32<16> prefix_max(const int32<16>& a, const int32<16>& b)
{
...
template<unsigned N> SIMDPP_INL
int32<N> prefix_max(const int32<N>& a, const int32<N>& b)
{
...
static SIMDPP_INL
uint32x4 prefix_max(const uint32x4& a, const uint32x4& b)
{
#if SIMDPP_USE_NULL
    return detail::null::max(a, b);
#elif SIMDPP_USE_SSE4_1
...
#if SIMDPP_USE_AVX2
static SIMDPP_INL
uint32x8 prefix_max(const uint32x8& a, const uint32x8& b)
{
...
#if SIMDPP_USE_AVX512F
static SIMDPP_INL
uint32<16> prefix_max(const uint32<16>& a, const uint32<16>& b)
{
...
template<unsigned N> SIMDPP_INL
uint32<N> prefix_max(const uint32<N>& a, const uint32<N>& b)
{
...
static SIMDPP_INL
int64x2 prefix_max(const int64x2& a, const int64x2& b)
{
...
#if SIMDPP_USE_AVX2
static SIMDPP_INL
int64x4 prefix_max(const int64x4& a, const int64x4& b)
{
#if SIMDPP_USE_AVX512VL
...
#if SIMDPP_USE_AVX512F
static SIMDPP_INL
int64<8> prefix_max(const int64<8>& a, const int64<8>& b)
{
...
template<unsigned N> SIMDPP_INL
int64<N> prefix_max(const int64<N>& a, const int64<N>& b)
{
...
static SIMDPP_INL
uint64x2 prefix_max(const uint64x2& a, const uint64x2& b)
{
#if SIMDPP_USE_AVX512VL
...
#if SIMDPP_USE_AVX2
static SIMDPP_INL
uint64x4 prefix_max(const uint64x4& a, const uint64x4& b)
{
#if SIMDPP_USE_AVX512VL
...
#if SIMDPP_USE_AVX512F
static SIMDPP_INL
uint64<8> prefix_max(const uint64<8>& a, const uint64<8>& b)
{
...
template<unsigned N> SIMDPP_INL
uint64<N> prefix_max(const uint64<N>& a, const uint64<N>& b)
{
